...
if (index !== -1) {
  console.log(`Using indexOf(): Element ${elementToFind} found at index ${index}`);
} else {
  console.log(`Using indexOf(): Element ${elementToFind} not found`);
}

// Using includes()
const includesElement = myArray.includes(elementToFind);
if (includesElement) {
  console.log(`Using includes(): Element ${elementToFind} is in the array`);
} else {
  console.log(`Using includes(): Element ${elementToFind} is not in the array`);
}

// Using find()
const foundElement = myArray.find(element => element === elementToFind);
if (foundElement !== undefined) {
  console.log(`Using find(): Element ${elementToFind} found`);
} else {
  console.log(`Using find(): Element ${elementToFind} not found`);
}
...
myArray.forEach((element, index) => {
  if (element === elementToFind) {
    found = true;
    console.log(`Using forEach(): Element ${elementToFind} found at index ${index}`);
  }
});

if (!found) {
  console.log(`Using forEach(): Element ${elementToFind} not found`);
}

///
// const array = [1, 2, 3, 4, 5];
// const indexToRemove = 2; // Index of the element you want to remove
// array.splice(indexToRemove, 1); // Removes 1 element from the specified index
// console.log(array); // Output: [1, 2, 4, 5]

//
// const array = [1, 2, 3, 4, 5];
// const elementToRemove = 3; // Element you want to remove
...
///if there are two elements in an unsorted array that sum up to zero:

// function hasSumZero(arr) {
...
// const array8 = [2, -3, 1, 0, 7, -1];
// console.log(hasSumZero(array8)); // Output: true (because -3 + 3 = 0)
...
//         // Calculate the complement to make the sum zero
//         const complement = -num;

//         // Check if the complement exists in the map
//         if (numMap.has(complement)) {
//             const complementIndex = numMap.get(complement);
//             return [num, complement, i, complementIndex];
//         }
...
// const array = [2, -3, 1, 0, 7, -1];
// const result = findSumZeroPair(array);

// if (result !== null) {
//     const [num1, num2, index1, index2] = result;
//     console.log(`Pair: ${num1} (Index ${index1}) and ${num2} (Index ${index2})`);
// } else {
